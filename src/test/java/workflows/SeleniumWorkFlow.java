...
public class SeleniumWorkFlow
{
  ...
  public boolean VerifymessageIsDisplayed(String message)
  {
    ...
    else
    {
        return true;
		   ...
		   public void WhenIClickoncevisibleDisplaysControlListPanelInNodeConfiguration(int index,String page, String XPath, String identification){
            try{
              
              customUtil customObject = new customUtil();
              customObject.ClickOnceVisible(XPath);
            }
            catch(Exception e)
            {
              throw new CustomException(e.getMessage(), e);
  ...
  public void WhenIDisabledelementControlNameSaveIsRestrictedInNodeConfiguration(int index,String page, String XPath, String identification){
            try{
  ...
  public void WhenIDisabledelementMoveControlSendIsRestrictedInNodeConfiguration(int index,String page, String XPath, String identification){
            try{
